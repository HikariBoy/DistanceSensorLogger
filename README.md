...
<img src="AssembledClosedBox.png" alt="Figure 1. Closed box showing USB input and GEFRAN PY2 distance sensor" align="left"  width="400"/> <figcaption>Figure 1. Closed box showing USB input and GEFRAN PY2 distance sensor</figcaption></div>
...
<div style="clear: both;"><img src="AssembledOpenedBox.png" alt="Figure 2. Opened Box showing (a) main board, (b) expanded view showing heatsink on 5V regulator, removed power jack, replaced with wiring to the panel mounted 2.5 mm jack, sensor wiring (see Figure 3) and connector to PY2 sensor on the 16Bit ADC" align="left"  width="800"/></div> <figcaption>Figure 2. Opened Box showing (a) main board, (b) expanded view showing heatsink on 5V regulator, removed power jack, replaced with wiring to the panel mounted 2.5 mm jack, sensor wiring (see Figure 3) and connector to PY2 sensor on the 16Bit ADC.</figcaption>
...
<div style="float: left"> <img src="./PY2.png" alt="Figure 3. GEFRAN PY2F10 Rectilinear Displacement sensor with color coded wiring to the Arduino  power rails and the ADS1115S ADC." align="left"  width="800"/> <figcaption>Figure 3. GEFRAN PY2F10 rectilinear Displacement sensor with color coded wiring to the Arduino  power rails and the ADS1115S ADC<figcaption></div>
...
<div style="float: right"><img src="./SchematicLayout.PNG" alt="Figure 4. Schematic of the Arduino (Uno) interface to the GEFRAN PY2 distance sensor through the 16Bit ADC" align="left"  width="400"/><figcaption>Figure 4. Schematic of the Arduino (Uno) interface to the GEFRAN PY2 distance sensor through the 16Bit ADC<figcaption></div>
  <P></P>
